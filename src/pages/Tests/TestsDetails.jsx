...
const TestsDetails = () => {
  ...
  const fetchFaqs = async (test_id) => {
    try {
      const response = await axios.get(`https://www.swasthyapro.com/api/admin/getfaq/${test_id}`);
  ...
  const fetchParameters = async (test_id) => {
    try {
      const response = await axios.get(`https://www.swasthyapro.com/api/admin/getparameters/${test_id}`);
